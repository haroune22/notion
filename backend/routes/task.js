...
import { createComment, removeComment, getComments } from '../controllers/commentController.js';
...
router.delete('/:taskId/comments/:commentId', authMiddleware, removeComment)
